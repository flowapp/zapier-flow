...
const listTasks = (z, bundle) => {
  return z
    .request({
      ...
      params: {
        organization_id: bundle.authData.orgId,
        workspace_id: bundle.inputData.workspace.id
      }
    })
    .then(response => JSON.parse(response.content))
    ...
    operation: {
      inputFields: [
        ...
        },
        {
          ...
          type: "integer",
          label: "Task Section",
          helpText: "If the project has todo sections, you can select one here. By default, the task will get added to the \"No Section\" list if you don't specify a section.",
        ...
        },
        {
          ...
          type: "text",
          label: "Task Note",
          helpText: "You can enter a note for the task. You can use [Github Flavored Markdown](https://help.github.com/articles/basic-writing-and-formatting-syntax/) for formatting.",
          required: false
        },
        {
          key: "dueDate",
